...
public class NuevaVentaController {
    ...
    public NuevaVentaController(NuevaVentaJDialog view, ConexionBD model, VentasController pc) {
        this.view = view;
        this.model = model;
        this.pc = pc;
        ...
        this.view.NuevoClienteButtonActionListener(this.getNuevoClienteActionListener());
    }
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (!disponibilidad) {
                    ...
                    if (venta) {
                        ...
                        pc.updateTableView();
                        JOptionPane.showMessageDialog(view, "Venta creada con exito", "Venta creada con exito", 1);
                        view.dispose();
                    } else {
